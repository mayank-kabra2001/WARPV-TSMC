...
generate //_\TLV
   ...
   assign replay_int = L0_replay_int_a0;
   assign dest_pending = L0_dest_pending_a0;
   assign reg_value1 = L1_Src[1].L1_reg_value_a0[31:0];
   assign reg_value2 = L1_Src[2].L1_reg_value_a0[31:0];
   assign out_pending1 = L1_Src[1].L1_pending_a0;
   assign out_pending2 = L1_Src[2].L1_pending_a0;
   
   assign L0_reg_write_a0 = L0_reset_a0 ? 1'b0 : L0_valid_dest_reg_valid_wr_a0;
   ...
   for (regs = 1; regs <= 31; regs=regs+1) begin : L1b_Regs //_/regs
      assign Regs_value_a0[regs][31:0] = ! L0_reset_a0 && (((regs == L0_dest_reg_wr_a0) && L0_reg_write_a0) ? L0_rslt_wr_a0 : Regs_value_a1[regs][31:0]);
   end
   ...
   for (regs = 1; regs <= 31; regs=regs+1) begin : L1c_Regs //_/regs
      assign Regs_pending_n1[regs] = ! L0_reset_a0 && (((regs == L0_dest_reg_wr_a0) && L0_valid_dest_reg_valid_wr_a0) ? L0_reg_wr_pending_wr_a0 : Regs_pending_a0[regs]);
